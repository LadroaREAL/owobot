...
client.on("ready", async () => {
  ...
  client.user.setActivity(`Ladroa tarafından OwO Publice`, { type: "PLAYING" });

  console.log("Ladroa tarafından OwO publice Yapılmıştır");
});
...
client.on('ready', () => {
  client.channels.cache.get('857603011655499786').join();
})